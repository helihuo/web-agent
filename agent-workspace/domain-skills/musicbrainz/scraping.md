...
UA = {"User-Agent": "web-agent/1.0 (your@email.com)"}
...
- **`User-Agent` is mandatory** — without it you get HTTP 403 instantly. The header must include contact info, e.g. `web-agent/1.0 (you@example.com)`. The default `http_get` UA (`Mozilla/5.0`) also gets 403.
